...
string Recipe::get_info()
{
    stringstream ss;
    ss << "Recipe ID: " << recipe_id << "<br />";
    ss << "Title: ";
    ss << "<a href=\"/UserHomePage/RecipeInfo?id=";
    ss << recipe_id << "\"" << ">";
    ss << title << "</a>";
    ss << "<br />"; 
    ss << "Vegetarian: ";
    ...
    ss << "<br />";
    ss << "Minutes to Ready: " << minutes_to_ready;
    return ss.str();
}
...
string Recipe::get_detailed_info()
{
    stringstream ss;
    ss << "Recipe ID: " << recipe_id << "<br />";
    ss << "Title: " << title << "<br />";
    ...
    ss << "<br />";
    ss << "minutes to ready: " << minutes_to_ready << "<br />";
    ss << "Tags: ";
    for (int i = 0; i<tags.size(); i++)
    {
        ss << tags[i];
    ...
    ss << "<br />";
    ss << "rating: " << fixed << setprecision(1) << round_up(rating) << "<br />";
    ss << "------------------------";
    return ss.str();
}
